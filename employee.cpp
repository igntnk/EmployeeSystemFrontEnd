...
Employee::Employee(uint8_t id,QString name,
                   QString surname,QString lastname, Task task, Rank rank,QString username,
                   QString password,QDate hiring_date,bool vacation):
    m_id(id),m_name(name),m_surname(surname),m_lastname(lastname),m_rank(rank),
...
void Employee::setLastName(QString lastname){m_lastname = lastname;}
